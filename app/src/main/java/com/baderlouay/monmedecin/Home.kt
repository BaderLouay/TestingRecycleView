...
import com.baderlouay.monmedecin.Models.DoctorViewModel
...
class Home : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        doctorRecyclerView = view.findViewById(R.id.recyclerView)
        ...
        viewModel.allDoctors.observe(viewLifecycleOwner, Observer {

            adapter.updateDoctorList(it)
